...
export default function RegisterPage() {
  ...
  return (
    <Layout title="AliShop - Register" description="Create a new account">
            ...
            <div className="pt-16 pb-8 px-8">
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  <Link href="/login" className="text-primary-main hover:text-primary-dark dark:text-primary-light dark:hover:text-primary-light/80 transition duration-300 font-medium">
                    Sign In
                  </Link>
                </p>
              </div>
